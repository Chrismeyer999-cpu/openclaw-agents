  ...
  return (
    <section className="mx-auto max-w-7xl space-y-6">
      <header className="space-y-1">
        <h1 className="text-2xl font-semibold tracking-tight text-gray-900">Nieuws Center</h1>
        <p className="text-sm text-gray-500">Gecombineerd nieuwsoverzicht voor kavelarchitect.nl, zwijsen.net en brikxai.nl.</p>
      ...
      <form className="grid gap-3 rounded-lg border border-gray-200 bg-white p-4 md:grid-cols-5">
        <label className="text-xs font-medium text-gray-600">
          Site
          <select name="workspace" defaultValue={workspaceFilter} className="mt-1 h-9 w-full rounded-md border border-gray-300 px-2 text-sm">
